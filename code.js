...
function generateDoc(e) {
  ...
  if (editors.length > 0) {
    var editorMail = editors[0].getEmail();
    MailApp.sendEmail(editorMail, doc.getName(), urldoc);
  }
 ...
 * Based on https://gist.github.com/smhmic/e7f9a8188f59bb1d9f992395c866a047
 */
function openUrl(url) {
  var html = HtmlService.createHtmlOutput(
    "<!DOCTYPE html><html><script>" +
      ...
      '<body style="word-break:break-word;font-family:sans-serif;">Failed to open automatically.  Click below:<br/><a href="' +
      url +
